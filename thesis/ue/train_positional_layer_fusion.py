...
from thesis.data_handling.locate import convert_onehot2tagging_scheme, convert_tagging2onehot
...
def train_positional_layer_fusion(cfg : DictConfig):
    ...
    num_tokens = dataset[0][0].shape[-3]  # first batch, first input #embedding size
